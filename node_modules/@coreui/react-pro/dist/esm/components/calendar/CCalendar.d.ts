...
import type { DisabledDate, SelectionTypes } from './types';
export interface CCalendarProps {
     ...
     * @since 5.24.0
     */
    renderMonthCell?: (date: Date, meta: {
        isDisabled: boolean;
        isInRange: boolean;
        isSelected: boolean;
    }) => ReactNode;
     ...
     * @since 5.24.0
     */
    renderQuarterCell?: (date: Date, meta: {
        isDisabled: boolean;
        isInRange: boolean;
        isSelected: boolean;
    }) => ReactNode;
     ...
     */
    onCalendarDateChange?: (date: Date | string, view: 'days' | 'months' | 'quarters' | 'years') => void;
    /**
