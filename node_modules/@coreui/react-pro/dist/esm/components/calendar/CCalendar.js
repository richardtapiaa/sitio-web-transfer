        ...
        if (range) {
            if (_selectEndDate) {
                if (_startDate && _startDate > date) {
                    handleStartDateChange(setTimeFromDate(date, _startDate));
    ...
    return (React.createElement("div", { className: classNames('calendars', {
        ...
        Array.from({ length: calendars }, (_, index) => {
            ...
            return (React.createElement("div", { className: classNames('calendar', view), key: index },
                ...
                React.createElement(CCalendarPanel, { calendarDate: calendarDate, dayFormat: dayFormat, disabledDates: disabledDates, endDate: _endDate, firstDayOfWeek: firstDayOfWeek, hoverDate: _hoverDate, locale: locale, maxDate: _maxDate, minDate: _minDate, monthFormat: monthFormat, onCalendarClick: (date) => handleCalendarClick(date, index), onCalendarKeyDown: (event, date) => handleCalendarKeyDown(event, date, index), onCalendarMouseEnter: handleCalendarMouseEnter, onCalendarMouseLeave: handleCalendarMouseLeave, order: index, renderDayCell: renderDayCell, renderMonthCell: renderMonthCell, renderQuarterCell: renderQuarterCell, renderYearCell: renderYearCell, selectAdjacementDays: selectAdjacementDays, selectEndDate: _selectEndDate, selectionType: selectionType, showAdjacementDays: showAdjacementDays, showWeekNumber: showWeekNumber, startDate: _startDate, view: view, weekdayFormat: weekdayFormat, weekNumbersLabel: weekNumbersLabel, yearFormat: yearFormat })));
        })));
});
CCalendar.propTypes = {
