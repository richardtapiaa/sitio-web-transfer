...
const createDateWithTime = (groups) => {
    ...
    const parsedMinute = Number.parseInt(minute !== null && minute !== void 0 ? minute : '0', 10) || 0;
    const parsedSecond = Number.parseInt(second !== null && second !== void 0 ? second : '0', 10) || 0;
...
export { convertIsoWeekToDate, convertToDateObject, createDateFromYear, createGroupsInArray, getCalendarDate, getDateBySelectionType, getISOWeekNumberAndYear, getLocalDateFromString, getMonthDetails, getMonthsNames, getSelectableDates, getYears, isDateDisabled, isDateInRange, isDateSelected, isDisableDateInRange, isMonthDisabled, isMonthInRange, isMonthSelected, isQuarterDisabled, isQuarterInRange, isQuarterSelected, isSameDateAs, isToday, isYearDisabled, isYearInRange, isYearSelected, parseYearSmart, removeTimeFromDate, setTimeFromDate };
