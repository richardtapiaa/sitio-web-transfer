...
export interface CDateRangePickerProps extends Omit<CFormControlWrapperProps, 'floatingLabel' | 'id'>, Omit<CPickerProps, 'placeholder' | 'id'>, Omit<CCalendarProps, 'onDayHover' | 'onCalendarDateChange'> {
    /**
