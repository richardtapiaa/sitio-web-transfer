...
const formatTimePartials = (values, locale, partial) => {
    ...
    return values.map((value) => {
        ...
        return {
            value,
            label: ((_a = formatter.formatToParts(date).find((part) => part.type === partial)) === null || _a === void 0 ? void 0 : _a.value) || '',
        };
    });
};
/**
...
export { convert12hTo24h, convert24hTo12h, convertTimeToDate, formatTimePartials, getAmPm, getLocalizedTimePartials, getSelectedHour, getSelectedMinutes, getSelectedSeconds, isAmPm, isValidTime, shouldUseTwoDigitHour };
