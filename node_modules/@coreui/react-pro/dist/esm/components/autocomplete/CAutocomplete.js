...
import { isExternalSearch, filterOptions, getFirstOptionByValue, flattenOptionsArray, getOptionLabel, isGlobalSearch, getFirstOptionByLabel } from './utils.js';
...
const CAutocomplete = forwardRef((_a, ref) => {
    ...
    const handleInputBlur = (event) => {
        ...
        const exactMatches = flattenOptionsArray(options).filter((option) => getOptionLabel(option).toLowerCase() === inputValueLower);
