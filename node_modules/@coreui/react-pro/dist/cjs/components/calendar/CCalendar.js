...
const CCalendar = React.forwardRef(({ ariaNavNextMonthLabel = 'Next month', ariaNavNextYearLabel = 'Next year', ariaNavPrevMonthLabel = 'Previous month', ariaNavPrevYearLabel = 'Previous year', startDate, endDate, calendarDate = startDate || endDate || null, calendars = 1, className, dayFormat = 'numeric', disabledDates, firstDayOfWeek = 1, locale = 'default', maxDate, minDate, monthFormat = 'short', navigation = true, navNextIcon, navNextDoubleIcon, navPrevIcon, navPrevDoubleIcon, navYearFirst, range, renderDayCell, renderMonthCell, renderQuarterCell, renderYearCell, selectAdjacementDays = false, selectEndDate, selectionType = 'day', showAdjacementDays = true, showWeekNumber = false, weekdayFormat = 2, weekNumbersLabel, yearFormat = 'numeric', onCalendarDateChange, onDateHover, onEndDateChange, onStartDateChange, onSelectEndChange, onViewChanged, }, ref) => {
    ...
    const setCalendarPage = (years, months = 0, setMonth) => {
        ...
        setCalendarDate(d);
        onCalendarDateChange === null || onCalendarDateChange === void 0 ? void 0 : onCalendarDateChange(d, view);
    ...
    const handleCalendarClick = (date, index) => {
        ...
        if (view === 'months' && selectionType !== 'month') {
            ...
            onCalendarDateChange === null || onCalendarDateChange === void 0 ? void 0 : onCalendarDateChange(_date, 'days');
            return;
        }
        if (view === 'years' && selectionType !== 'year') {
            ...
            if (selectionType === 'quarter') {
                ...
                onCalendarDateChange === null || onCalendarDateChange === void 0 ? void 0 : onCalendarDateChange(_date, 'quarters');
            }
            else {
                handleViewChange('months');
                onCalendarDateChange === null || onCalendarDateChange === void 0 ? void 0 : onCalendarDateChange(_date, 'months');
            }
            return;
        }
        ...
        if (range) {
            if (_selectEndDate) {
                if (_startDate && _startDate > date) {
                    handleStartDateChange(utils.setTimeFromDate(date, _startDate));
    ...
    return (React.createElement("div", { className: index.default('calendars', {
        ...
        Array.from({ length: calendars }, (_, index$1) => {
            ...
            return (React.createElement("div", { className: index.default('calendar', view), key: index$1 },
                ...
                React.createElement(CCalendarPanel.CCalendarPanel, { calendarDate: calendarDate, dayFormat: dayFormat, disabledDates: disabledDates, endDate: _endDate, firstDayOfWeek: firstDayOfWeek, hoverDate: _hoverDate, locale: locale, maxDate: _maxDate, minDate: _minDate, monthFormat: monthFormat, onCalendarClick: (date) => handleCalendarClick(date, index$1), onCalendarKeyDown: (event, date) => handleCalendarKeyDown(event, date, index$1), onCalendarMouseEnter: handleCalendarMouseEnter, onCalendarMouseLeave: handleCalendarMouseLeave, order: index$1, renderDayCell: renderDayCell, renderMonthCell: renderMonthCell, renderQuarterCell: renderQuarterCell, renderYearCell: renderYearCell, selectAdjacementDays: selectAdjacementDays, selectEndDate: _selectEndDate, selectionType: selectionType, showAdjacementDays: showAdjacementDays, showWeekNumber: showWeekNumber, startDate: _startDate, view: view, weekdayFormat: weekdayFormat, weekNumbersLabel: weekNumbersLabel, yearFormat: yearFormat })));
        })));
});
CCalendar.propTypes = {
