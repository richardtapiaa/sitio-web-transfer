...
const CCalendarPanel = React.forwardRef(({ calendarDate, dayFormat, disabledDates, endDate, firstDayOfWeek, hoverDate, locale, maxDate, minDate, monthFormat, onCalendarClick, onCalendarKeyDown, onCalendarMouseEnter, onCalendarMouseLeave, renderDayCell, renderMonthCell, renderQuarterCell, renderYearCell, selectAdjacementDays, selectEndDate, selectionType, showWeekNumber, showAdjacementDays, startDate, view, weekdayFormat, weekNumbersLabel, yearFormat, }, ref) => {
    const [listOfMonths, setListOfMonths] = React.useState([]);
    React.useEffect(() => {
        setListOfMonths(utils.createGroupsInArray(utils.getMonthsNames(locale, monthFormat), 4));
    }, []);
                    ...
                    return (React.createElement("tr", Object.assign({ className: index.default('calendar-row', selectionType === 'week' && {
                        ...
                        days.map(({ date, month }, idx) => {
                            ...
                            return month === 'current' || showAdjacementDays ? (React.createElement("td", Object.assign({ className: index.default('calendar-cell', Object.assign(Object.assign({}, (selectionType === 'day' && {
                                ...
                                React.createElement("div", { className: "calendar-cell-inner" }, renderDayCell
                                    ? renderDayCell(date, {
                                        isDisabled,
                                        isInCurrentMonth: month === 'current',
                                        isInRange: utils.isDateInRange(date, startDate, endDate),
                                        isSelected,
                ...
                listOfMonths.map((row, index$1) => {
                    return (React.createElement("tr", { key: index$1 }, row.map((month, idx) => {
                        ...
                        return (React.createElement("td", Object.assign({ className: index.default('calendar-cell', {
                            ...
                            React.createElement("div", { className: "calendar-cell-inner" }, renderMonthCell
                                ? renderMonthCell(date, {
                                    isDisabled,
                                    isInRange: utils.isMonthInRange(date, startDate, endDate),
                                    isSelected,
                                })
                                : month)));
                    })));
                }),
            view === 'quarters' && (React.createElement("tr", null, Array.from({ length: 4 }, (_, index$1) => {
                const date = new Date(calendarDate.getFullYear(), index$1 * 3, 1);
                const isDisabled = utils.isQuarterDisabled(date, minDate, maxDate, disabledDates);
                const isSelected = utils.isQuarterSelected(date, startDate, endDate);
                return (React.createElement("td", Object.assign({ className: index.default('calendar-cell quarters', {
                        disabled: isDisabled,
                        selected: isSelected,
                        'range-hover': selectionType === 'quarter' &&
                            (hoverDate && selectEndDate
                                ? utils.isQuarterInRange(date, startDate, hoverDate)
                                : utils.isQuarterInRange(date, hoverDate, endDate)),
                        range: utils.isQuarterInRange(date, startDate, endDate),
                    }), key: index$1, tabIndex: isDisabled ? -1 : 0 }, (isSelected && { 'aria-selected': true }), (!isDisabled && {
                    onBlur: () => onCalendarMouseLeave(),
                    onClick: () => onCalendarClick(date),
                    onFocus: () => onCalendarMouseEnter(date),
                    onKeyDown: (event) => onCalendarKeyDown(event, date),
                    ...
                    React.createElement("div", { className: "calendar-cell-inner" }, renderQuarterCell
                        ? renderQuarterCell(date, {
                            isDisabled,
                            isInRange: utils.isQuarterInRange(date, startDate, endDate),
                            isSelected,
                        })
                        : `Q${index$1 + 1}`)));
            }))),
                ...
                listOfYears.map((row, index$1) => {
                    return (React.createElement("tr", { key: index$1 }, row.map((year, idx) => {
                        ...
                        return (React.createElement("td", Object.assign({ className: index.default('calendar-cell year', {
                            ...
                            React.createElement("div", { className: "calendar-cell-inner" }, renderYearCell
                                ? renderYearCell(date, {
                                    isDisabled,
                                    isInRange: utils.isYearInRange(date, startDate, endDate),
                                    isSelected,
                                })
