...
const CSidebar = React.forwardRef((_a, ref) => {
    ...
    const [visibleDesktop, setVisibleDesktop] = React.useState(visible !== undefined ? visible : overlaid ? false : true);
    React.useEffect(() => {
    ...
    React.useEffect(() => {
        var _a, _b;
        sidebarRef.current && setMobile(isOnMobile(sidebarRef.current));
        sidebarRef.current && setInViewport(isInViewport.default(sidebarRef.current));
