...
const CSmartTableHead = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(Component, Object.assign({}, rest, { ref: ref }),
                ...
                const isSortable = columnSorter &&
                    (typeof column === 'object'
                        ? column.sorter === undefined
                            ...
                            : column.sorter
                        : true);
                return (React.createElement(CTableHeaderCell.CTableHeaderCell, Object.assign({}, utils.getTableHeaderCellProps(column), { style: utils.getTableHeaderCellStyles(column, columnSorter), key: index }, (isSortable && {
                    onClick: () => handleSort && handleSort(utils.getColumnKey(column), index),
                    onKeyDown: (event) => {
        ...
        columnFilter && (React.createElement(CTableRow.CTableRow, null,
            selectable && React.createElement(CTableHeaderCell.CTableHeaderCell, null),
            _columns.map((column, index) => {
                return (React.createElement(CTableHeaderCell.CTableHeaderCell, Object.assign({}, utils.getTableHeaderCellProps(column), { key: index }), (typeof column === 'object'
                    ? column.filter === undefined
                        ? true
                        : column.filter
                    : true) ? (typeof column !== 'string' && typeof column.filter === 'function' ? (column.filter(utils.getColumnValues(items, utils.getColumnKey(column)), (value) => handleOnCustomFilterChange &&
                    handleOnCustomFilterChange(utils.getColumnKey(column), value), columnFilterState && columnFilterState[utils.getColumnKey(column)]
                    ? columnFilterState[utils.getColumnKey(column)]
                    : undefined)) : (React.createElement(CFormInput.CFormInput, { size: "sm", onInput: (event) => handleFilterOnInput &&
                        handleFilterOnInput(utils.getColumnKey(column), event.target.value), onChange: (event) => handleFilterOnChange &&
                        handleFilterOnChange(utils.getColumnKey(column), event.target.value), value: columnFilterState && columnFilterState[utils.getColumnKey(column)]
                        ? columnFilterState[utils.getColumnKey(column)]
