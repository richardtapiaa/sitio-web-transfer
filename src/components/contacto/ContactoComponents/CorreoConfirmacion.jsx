...
import emailAnimacion from '@/assets/lottie/email-green.json';

export default function CorreoConfirmacion({ lang, onClose }) {
    ...
    return createPortal(
        ...
        >
            ...
            >
                {t(lang, 'contact.success.message')}
            </p>
